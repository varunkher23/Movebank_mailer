...
#print(f"tag\tn_points\tn_acc\tlatest_battery_voltage\t\tlast_timestamp\t\tdate_diff.days\tlast_location")
tag_list=[]
...
output=pd.DataFrame(data={'Tag ID':tag_list, 'GPS Locations (7 days)':n_points_list,'Accelerometer recordings (7 days)':n_acc_list, 'Last Timestamp':last_timestamp_list,'Time since last location':date_diff_list,                          'Last Location' : last_location_list,'Last Battery Voltage':latest_battery_voltage_list
                         })
output
...
kml.save("D:\WII_BRP\Automation\Movebank_mailer\df_kml.kml")
...
send_email(["varunkher23@gmail.com","shimontikagupta@gmail.com"], "Tagged GIB locations for last week", "D:\WII_BRP\Automation\Movebank_mailer\df_kml.kml")#
